...
<i class="far fa-thumbs-up"></i> Checkpoints

<i class="far fa-thumbs-up"></i> Modular, flexible

<i class="far fa-thumbs-up"></i> HPC queue managers and [DRMAA](http://www.drmaa.org/)

<i class="far fa-thumbs-up"></i> Portable, containerized environments
...
<i class="far fa-thumbs-up"></i> Portable

<i class="far fa-thumbs-up"></i> Track software versions

<i class="far fa-thumbs-up"></i> Track the external source to retrieve from
